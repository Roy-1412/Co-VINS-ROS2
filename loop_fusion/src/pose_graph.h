...
public:
  ...
  ~PoseGraph(); 
	...
	CameraPoseVisualization* camerapose_visualization;

	void savePoseGraph();
	void loadPoseGraph();
	void publish();
	void publishTF();
	//void pubLoopedCameraPose(const std_msgs::msg::Header &header, int sequence);
	std::shared_ptr<tf2_ros::Buffer> getBuffer() { return tf_buffer; }
...
private:
 ...
 rclcpp::Publisher<visualization_msgs::msg::Marker>::SharedPtr marker_pub;
	...
	rclcpp::Publisher<nav_msgs::msg::Path>::SharedPtr pub_pg_path1;
  	rclcpp::Publisher<nav_msgs::msg::Path>::SharedPtr pub_pg_path2;
  	rclcpp::Publisher<nav_msgs::msg::Path>::SharedPtr pub_pg_path3;
  	rclcpp::Publisher<nav_msgs::msg::Path>::SharedPtr pub_pg_path4;
	rclcpp::Publisher<visualization_msgs::msg::MarkerArray>::SharedPtr pub_looped_pose1;
	rclcpp::Publisher<visualization_msgs::msg::MarkerArray>::SharedPtr pub_looped_pose2;
	rclcpp::Publisher<visualization_msgs::msg::MarkerArray>::SharedPtr pub_looped_pose3;
	rclcpp::Publisher<visualization_msgs::msg::MarkerArray>::SharedPtr pub_looped_pose4;
