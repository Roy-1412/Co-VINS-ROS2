...
int main(int argc, char **argv)
{
    ...
    n->declare_parameter<std::string>(
        "mesh_resource",
        std::string("package://loop_fusion/meshes/hummingbird.mesh"));
    ...
    sub_odom1 = n->create_subscription<nav_msgs::msg::Odometry>("/vins_1/vins_estimator/odometry",  rclcpp::QoS(100),  odom_callback);
    sub_odom2 = n->create_subscription<nav_msgs::msg::Odometry>("/vins_2/vins_estimator/odometry",  rclcpp::QoS(100),  odom_callback);
    sub_odom3 = n->create_subscription<nav_msgs::msg::Odometry>("/vins_3/vins_estimator/odometry",  rclcpp::QoS(100),  odom_callback);
    sub_odom4 = n->create_subscription<nav_msgs::msg::Odometry>("/vins_4/vins_estimator/odometry",  rclcpp::QoS(100),  odom_callback);
