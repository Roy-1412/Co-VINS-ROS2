...
def generate_launch_description():
    ...
    sequence_1_arg = DeclareLaunchArgument(
        'sequence_1',
        default_value='/home/roy/Desktop/test/test.db3',
        #default_value='/home/roy/Desktop/ROY/ROY.db3',
    ...
    config_file_path = '/home/roy/Desktop/Co-VINS/config/euroc/euroc_config.yaml'
    #config_file_path = '/home/roy/Desktop/Co-VINS/config/zed2i/zed2i_imu_config.yaml'
    ...
    pose_graph_node = Node(
        ...
        parameters=[
            ...
            {'skip_cnt': 0},
            {'skip_dis': 0.0},
            {'pose_graph_save_path': '/home/roy/output/pose_graph/'},
            {'pose_graph_result_path': '/home/roy/output/'}
        ]
    )
